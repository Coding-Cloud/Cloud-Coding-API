...
export class file1657907888786 implements MigrationInterface {
  name = 'file1657907888786';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."project_language_enum" AS ENUM('ANGULAR', 'REACT', 'QUARKUS', 'NESTJS', 'FLASK')`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."project_language_enum_old" AS ENUM('ANGULAR', 'REACT', 'QUARKUS', 'NESTJS')`,
    );
    await queryRunner.query(`ALTER TABLE "project"
