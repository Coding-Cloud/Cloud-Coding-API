...
export class file1650059947625 implements MigrationInterface {
  name = 'file1650059947625';
    ...
    await queryRunner.query(
      `CREATE TABLE "friendship"
       (
           ...
           "createdAt" TIMESTAMP         NOT NULL DEFAULT now(),
           CONSTRAINT "PK_4f31989946167a1964ae8c328ed" PRIMARY KEY ("user1Id", "user2Id")
       )`,
    );
    await queryRunner.query(
